    ...
    public function getRoutes(): array
    {
        ...
        return [
            'getOccurrences' => new Route(
                '/extensions/boltformaddon/getOccurrences',
                [
            ...
            'getOccurExtendedDetail' => new Route(
                '/extensions/boltformaddon/getOccurExtendedDetail',
                ['_controller' => 'Webdevchampion\BoltformaddonExtension\Controller::getOccurExtendedDetail'],
                ['name' => '[a-zA-Z0-9]+']
            ),
            'getStudentDetail' => new Route(
                '/extensions/boltformaddon/getStudentDetail',
                ['_controller' => 'Webdevchampion\BoltformaddonExtension\Controller::getStudentDetail'],
                ['name' => '[a-zA-Z0-9]+']
            ),
            'registerStudent' => new Route(
                '/extensions/boltformaddon/registerStudent',
                ['_controller' => 'Webdevchampion\BoltformaddonExtension\Controller::registerStudent'],
                ['name' => '[a-zA-Z0-9]+']
            ),
            'proceedPayment' => new Route(
                '/extensions/boltformaddon/proceedPayment',
                ['_controller' => 'Webdevchampion\BoltformaddonExtension\Controller::proceedPayment'],
                ['name' => '[a-zA-Z0-9]+']
            ),
            'applyPromo' => new Route(
                '/extensions/boltformaddon/applyPromo',
                ['_controller' => 'Webdevchampion\BoltformaddonExtension\Controller::applyPromo'],
                ['name' => '[a-zA-Z0-9]+']
            ),				
        ];
    }
